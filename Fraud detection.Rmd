---
title: "Frdaud Detection"
author: "Ivan Liu"
date: "Friday, August 22, 2014"
output: html_document
title: "Modified Ivan's items to simplify the interfaces and added semi-supervised learning.  In addition, threw in the skeleton for a genetic algorithm comparison to a GARCH-AR model."
author: "John Menerick"
date: "Tuesday, Oct. 6, 2015"
output: html_document"
---
<br/>
This psuedo-library may be used to predict whether the sales trasactions are fraud or not.  As this project itching a scratch, the genetic algo. leaves much to be desired.
...
```{r, echo=FALSE, message=F, tidy=TRUE,comment=NA, results='hide'}
summary(sales)
nlevels(sales$ID)
nlevels(sales$Prod)
...
```{r, echo=FALSE, message=F, tidy=TRUE,comment=NA, fig.width=10, results='hide'}
...
#### Data cleaning
1. Data imputation
2. Figure out the similarities between products with very few transactions
3. Group small ones with high similarities
<br/>
```{r, echo=FALSE, message=F, tidy=TRUE,comment=NA, results='hide', warning=FALSE}
totS <- table(ID)
totP <- table(Prod)
...
#### Model Evaluation
1. ROCR - Precision/Recall curves
2. Cumulative recall chart
3. Evaluation matrix 
<br/>
```{r, echo=FALSE, message=F, tidy=TRUE,comment=NA, results='hide', warning=FALSE}
...
1. Normalized distance to typical unit price
2. Local Outlier Factors
3. Clustering-Based Outlier Rankings
<br/>
```{r, echo=FALSE, message=F, tidy=TRUE,comment=NA, results='hide', warning=FALSE}
...
#### Supervised Learning
1. Naive Bayes
2. Naive Bayes with modified training set
<br/>
```{r, echo=FALSE, message=F, tidy=TRUE,comment=NA, results='hide', warning=FALSE}
## Naive Bayes
...
1. Navie Bayes with self training
<br/>
```{r, echo=FALSE, message=F, tidy=TRUE,comment=NA, results='hide', warning=FALSE}
